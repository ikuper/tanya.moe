...
window.javascriptLocales = {
	copyMessage: "Just wanted to let you know that Tanya is always with you! Even inside your clipboard! We are everywhere and you should really join us!\n" +
		"Also yes, any website can access your clipboard however they want, isn't that creepy?\n" +
		"Regardless, Tanya is the BEST WAIFU, and you should agree! tanya.moe",
...
discordInfo("DFdXSMk").then(fetchedGuild => {
	guild = fetchedGuild;
	updateCounts();
})

subredditInfo("YoujoSenki").then(fetchedSubreddit => {
